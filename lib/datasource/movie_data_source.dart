...
class MovieDataSource{
  ...
  final _loadAfterStateSubject = BehaviorSubject<bool>(seedValue: false);
  Observable<bool> get networkState => _loadAfterStateSubject.stream;
  ...
  loadAfter() async{
    var movieList = await repository.getMovieList(page).catchError((error){
      _loadAfterStateSubject.addError(error);
      return;
    });
    var currentpage = int.tryParse(movieList.metaData.currentPage);
